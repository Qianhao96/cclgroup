...
`}
                    ...
                    <h4>Structure</h4>
                    <p>
                        Ultima consists of 3 main parts; the application layout, layout resources and theme resources for PrimeReact components. <b>App.tsx</b> inside src folder is the main component containing the template for the base layout
                    ...
                    <h4>Template</h4>
                    <p>
                        Main layout is the JSX of the App.tsx, it is divided into a couple of child components such as topbar, profile, menu and footer. Here is render method of the App.tsx component that implements the logic such as menu state,
...
`}
                    ...
                    <h4>Menu</h4>
                    <p>
                        Menu is a separate component defined in <i>AppMenu.tsx</i> file based on PrimeReact MenuModel API. In order to define the menuitems, navigate to data section of <i>App.tsx</i> file and define your own model as a nested
                        structure using the menu property. Here is the menu component from the demo application. Notice that menu object is bound to the model property of AppMenu component as shown above.
                    </p>
...
`}
                    ...
                    <p>Dependencies of Layout are listed below and needs to be added to package.tsxon. Only required dependency is PrimeReact where optional dependencies exist to enable certain components in PrimeReact.</p>
...
`}
                    ...
                    <p>
                        It is a separate component defined in AppTopbar.tsx file. This menu can be fully customized according to the application's needs. There are special classes in the topbar to provide some interactions such as hover,
...
`}
                    ...
                    <p>
                        It is a separate component defined in AppRightMenu.tsx file based on PrimeReact <a href="https://primefaces.org/primereact/showcase/#/sidebar">Sidebar</a> component. All properties of the sidebar component are available. The
...
`}
                    ...
                    <p>
                        It is a separate component defined in AppInlineMenu.tsx file. This menu can be fully customized according to the application's needs and it is created according to its location within the element with the layout-menu-container
...
`}
                    ...
                    <p>
                        It is a separate component defined in AppBreadcrumb.tsx file based on PrimeReact <a href="https://primefaces.org/primereact/showcase/#/breadcrumb">Breadcrumb</a> component. All properties of the breadcrumb component are
...
$panelContentEvenRowBg:rgba(0,0,0,.05);
