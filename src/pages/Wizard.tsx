            ...
            <div className="wizard-wrapper">
                <div className="wizard-topbar">
                    ...
                    <div className="profile">
                        ...
                        <img className="profile-image" src="assets/layout/images/extensions/flag-us@2x.png" alt="ultima-layout" />
                    </div>
                </div>
                    ...
                    <div className="wizard-card">
                        <div className="wizard-card-header">
                            <div className="grid col-12">
                                <div
                                    className={classNames('col-4 tab register-tab', {
                                        'selected-tab': activeTab === 'register'
                                    })}
                                ...
                                <div
                                    className={classNames('col-4 tab tier-tab', {
                                        'selected-tab': activeTab === 'tier'
                                    })}
                                ...
                                <div
                                    className={classNames('col-4 tab payment-tab', {
                                        'selected-tab': activeTab === 'payment'
                                    })}
                        ...
                        <div
                            className={classNames('wizard-card-content register', {
                                'active-content': activeTab === 'register'
                            })}
                        >
                            <div className="grid">
                                ...
                                <div className="col-12 lg:col-6">
                                    ...
                                    <div className="forms">
                                        ...
                                        <div className="calendar">
                                            <Calendar id="button" appendTo={document.body} placeholder="Birthdate" showIcon={true} value={date} onChange={(e) => setDate(e.value)} />
                                        </div>

                                        <Dropdown id="ultima" appendTo={document.body} options={dropdownOptions2} value={dropdownHear} onChange={(event) => setDropdownHear(event.value)} />
                                    </div>
                                </div>
                        ...
                        <div
                            className={classNames('wizard-card-content tier', {
                                'active-content': activeTab === 'tier'
                            })}
                        >
                            <div className="grid">
                                ...
                                <div className="col-12 md:col-6 lg:col-4">
                                    <div className="card pro-plus">
                                        ...
                                        <div className="card-content">
                                            ...
                                            <div className="col-12 tier-button-wrapper">
                                                <Button
                                                    className="tier-button pro-plus"
                                                    label="SELECT PRO+"
                                                    onClick={() => {
                        ...
                        <div
                            className={classNames('wizard-card-content payment', {
                                'active-content': activeTab === 'payment'
                            })}
                        >
                            <div className="grid grid-nogutter">
                                ...
                                <div className="lg:col-4 col-12 order-info">
                                    ...
                                    <div
                                        className={classNames('order order-default', {
                                            'selected-order': activeCard === ''
                                        })}
                                    >
                                        <div className="grid col-12">
                                        ...
                                        <div className="grid col-12 total">
                                            ...
                                            <div className="col-4 price">$0.00</div>
                                            <div className="col-12">Please select one tier.</div>
                                        </div>
                                    </div>
                                    <div
                                        className={classNames('order order-basic', {
                                            'selected-order': activeCard === 'basic'
                                        })}
                                    >
                                        <div className="grid col-12">
                                    ...
                                    <div
                                        className={classNames('order order-pro', {
                                            'selected-order': activeCard === 'pro'
                                        })}
                                    >
                                        <div className="grid col-12">
                                    ...
                                    <div
                                        className={classNames('order order-pro-plus', {
                                            'selected-order': activeCard === 'pro-plus'
                                        })}
                                    >
                                        <div className="grid col-12">
                                            <div className="col-8">Tier - Pro+</div>
